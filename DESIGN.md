...
Flow: keep Tor connected → disable competing proxy extensions and old Rozaneh → install → enable route → explicitly test Tor → open Gemini and verify an actual answer. Failure states distinguish proxy ownership, transport test, and Gemini application errors.
...
Tokens: Vazirmatn local; canvas #f5f7f6, surface #ffffff, text #152c29, muted #526662, accent #087568, border #d5dfdc, error #a32f24. 16px body; 24px title; 8/12/16/24px spacing; 12/18px radii. Existing Rozaneh icon retained as identity.
