...
Not tested: real Chrome installation of 0.4.0, real Windows Tor setup, Flow generation or Notebook source upload/answer. Flow account requirements and credits still apply. Tor speed and exit acceptance can change.
